...
const (
	...
	// IdentityManagementModePolicyController means cilium-policy-controller is solely responsible for managing CiliumIdentity.
...
// CentralizedNetworkPolicyEnabled returns true if cilium agent needs to support Centralized NetworkPolicy, false otherwise.
