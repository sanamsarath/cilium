...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SlimCRP) DeepCopyInto(out *SlimCRP) {
	*out = *in
	if in.CiliumResolvedPolicy != nil {
		in, out := &in.CiliumResolvedPolicy, &out.CiliumResolvedPolicy
		*out = new(v2alpha1.CiliumResolvedPolicy)
		(*in).DeepCopyInto(*out)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SlimCRP.
func (in *SlimCRP) DeepCopy() *SlimCRP {
	if in == nil {
		return nil
	}
	out := new(SlimCRP)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *SlimCRP) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
