...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *SlimCRP) DeepEqual(other *SlimCRP) bool {
	if other == nil {
		return false
	}

	if (in.CiliumResolvedPolicy == nil) != (other.CiliumResolvedPolicy == nil) {
		return false
	} else if in.CiliumResolvedPolicy != nil {
		if !in.CiliumResolvedPolicy.DeepEqual(other.CiliumResolvedPolicy) {
			return false
		}
	}
