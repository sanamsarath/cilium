...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CRPPeerRule) DeepEqual(other *CRPPeerRule) bool {
	if other == nil {
		return false
	}

	if ((in.MatchingPeerIdentities != nil) && (other.MatchingPeerIdentities != nil)) || ((in.MatchingPeerIdentities == nil) != (other.MatchingPeerIdentities == nil)) {
		in, other := &in.MatchingPeerIdentities, &other.MatchingPeerIdentities
		if other == nil {
			return false
		}
...
func (in *CiliumResolvedPolicySpec) DeepEqual(other *CiliumResolvedPolicySpec) bool {
	...
	if ((in.SubjectIdentities != nil) && (other.SubjectIdentities != nil)) || ((in.SubjectIdentities == nil) != (other.SubjectIdentities == nil)) {
		in, other := &in.SubjectIdentities, &other.SubjectIdentities
		if other == nil {
			return false
		}
	...
	if ((in.IngressRuleIdentities != nil) && (other.IngressRuleIdentities != nil)) || ((in.IngressRuleIdentities == nil) != (other.IngressRuleIdentities == nil)) {
		in, other := &in.IngressRuleIdentities, &other.IngressRuleIdentities
		if other == nil {
			return false
		}
	...
	if ((in.IngressDenyRuleIdentities != nil) && (other.IngressDenyRuleIdentities != nil)) || ((in.IngressDenyRuleIdentities == nil) != (other.IngressDenyRuleIdentities == nil)) {
		in, other := &in.IngressDenyRuleIdentities, &other.IngressDenyRuleIdentities
		if other == nil {
			return false
		}
	...
	if ((in.EgressRuleIdentities != nil) && (other.EgressRuleIdentities != nil)) || ((in.EgressRuleIdentities == nil) != (other.EgressRuleIdentities == nil)) {
		in, other := &in.EgressRuleIdentities, &other.EgressRuleIdentities
		if other == nil {
			return false
		}
	...
	if ((in.EgressDenyRuleIdentities != nil) && (other.EgressDenyRuleIdentities != nil)) || ((in.EgressDenyRuleIdentities == nil) != (other.EgressDenyRuleIdentities == nil)) {
		in, other := &in.EgressDenyRuleIdentities, &other.EgressDenyRuleIdentities
		if other == nil {
			return false
		}
...
func (in *CiliumResolvedPolicyStatus) DeepEqual(other *CiliumResolvedPolicyStatus) bool {
	...
	if in.Processed != other.Processed {
		return false
	}
	if (in.ProcessingTime == nil) != (other.ProcessingTime == nil) {
		return false
	} else if in.ProcessingTime != nil {
		if !in.ProcessingTime.DeepEqual(other.ProcessingTime) {
			return false
		}
	}
