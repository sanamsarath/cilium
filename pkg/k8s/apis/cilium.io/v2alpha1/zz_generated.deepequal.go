...
func (in *CiliumResolvedPolicySpec) DeepEqual(other *CiliumResolvedPolicySpec) bool {
	...
	if (in.RuleSelector == nil) != (other.RuleSelector == nil) {
		return false
	} else if in.RuleSelector != nil {
		if !in.RuleSelector.DeepEqual(other.RuleSelector) {
			return false
		}
	}

	if ((in.IngressRuleSelectors != nil) && (other.IngressRuleSelectors != nil)) || ((in.IngressRuleSelectors == nil) != (other.IngressRuleSelectors == nil)) {
		in, other := &in.IngressRuleSelectors, &other.IngressRuleSelectors
		if other == nil {
			return false
		}
	...
	if ((in.EgressRuleSelectors != nil) && (other.EgressRuleSelectors != nil)) || ((in.EgressRuleSelectors == nil) != (other.EgressRuleSelectors == nil)) {
		in, other := &in.EgressRuleSelectors, &other.EgressRuleSelectors
		if other == nil {
			return false
		}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *ResolvedSelector) DeepEqual(other *ResolvedSelector) bool {
	if other == nil {
		return false
	}
