...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CRPPeerRule) DeepCopyInto(out *CRPPeerRule) {
	*out = *in
	if in.MatchingPeerIdentities != nil {
		in, out := &in.MatchingPeerIdentities, &out.MatchingPeerIdentities
		*out = make([]identity.NumericIdentity, len(*in))
		copy(*out, *in)
	}
	if in.ToPorts != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CRPPeerRule.
func (in *CRPPeerRule) DeepCopy() *CRPPeerRule {
	if in == nil {
		return nil
	}
	out := new(CRPPeerRule)
...
func (in *CiliumResolvedPolicySpec) DeepCopyInto(out *CiliumResolvedPolicySpec) {
	*out = *in
	...
	if in.SubjectIdentities != nil {
		in, out := &in.SubjectIdentities, &out.SubjectIdentities
		*out = make([]identity.NumericIdentity, len(*in))
		copy(*out, *in)
	}
	if in.IngressRuleIdentities != nil {
		in, out := &in.IngressRuleIdentities, &out.IngressRuleIdentities
		*out = make([]CRPPeerRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.IngressDenyRuleIdentities != nil {
		in, out := &in.IngressDenyRuleIdentities, &out.IngressDenyRuleIdentities
		*out = make([]CRPPeerRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.EgressRuleIdentities != nil {
		in, out := &in.EgressRuleIdentities, &out.EgressRuleIdentities
		*out = make([]CRPPeerRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.EgressDenyRuleIdentities != nil {
		in, out := &in.EgressDenyRuleIdentities, &out.EgressDenyRuleIdentities
		*out = make([]CRPPeerRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *CiliumResolvedPolicyStatus) DeepCopyInto(out *CiliumResolvedPolicyStatus) {
	*out = *in
	if in.ProcessingTime != nil {
		in, out := &in.ProcessingTime, &out.ProcessingTime
		*out = (*in).DeepCopy()
	}
	return
}
