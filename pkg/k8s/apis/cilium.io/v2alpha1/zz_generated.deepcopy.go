...
func (in *CiliumResolvedPolicySpec) DeepCopyInto(out *CiliumResolvedPolicySpec) {
	*out = *in
	...
	if in.RuleSelector != nil {
		...
		*out = new(ResolvedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.IngressRuleSelectors != nil {
		in, out := &in.IngressRuleSelectors, &out.IngressRuleSelectors
		*out = make([]ResolvedSelector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.EgressRuleSelectors != nil {
		in, out := &in.EgressRuleSelectors, &out.EgressRuleSelectors
		*out = make([]ResolvedSelector, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResolvedSelector) DeepCopyInto(out *ResolvedSelector) {
	*out = *in
	if in.Selector != nil {
		in, out := &in.Selector, &out.Selector
		*out = new(api.EndpointSelector)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResolvedSelector.
func (in *ResolvedSelector) DeepCopy() *ResolvedSelector {
	if in == nil {
		return nil
	}
	out := new(ResolvedSelector)
