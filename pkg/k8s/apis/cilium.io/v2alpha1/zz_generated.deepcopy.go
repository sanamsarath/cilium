...
func (in *AppliesTo) DeepCopyInto(out *AppliesTo) {
	*out = *in
	...
	if in.PodSelectorLabels != nil {
		in, out := &in.PodSelectorLabels, &out.PodSelectorLabels
		*out = make([]PodSelectorLabel, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *CiliumResolvedPolicySpec) DeepCopyInto(out *CiliumResolvedPolicySpec) {
	*out = *in
	...
	if in.IngressRules != nil {
		...
		*out = make([]IngressResolvedRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.IngressDenyRules != nil {
		in, out := &in.IngressDenyRules, &out.IngressDenyRules
		*out = make([]IngressResolvedRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	...
	if in.EgressRules != nil {
		...
		*out = make([]EgressResolvedRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.EgressDenyRules != nil {
		in, out := &in.EgressDenyRules, &out.EgressDenyRules
		*out = make([]EgressResolvedRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EgressResolvedRule) DeepCopyInto(out *EgressResolvedRule) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EgressResolvedRule.
func (in *EgressResolvedRule) DeepCopy() *EgressResolvedRule {
	if in == nil {
		return nil
	}
	out := new(EgressResolvedRule)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IngressResolvedRule) DeepCopyInto(out *IngressResolvedRule) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IngressResolvedRule.
func (in *IngressResolvedRule) DeepCopy() *IngressResolvedRule {
	if in == nil {
		return nil
	}
	out := new(IngressResolvedRule)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodSelectorLabel) DeepCopyInto(out *PodSelectorLabel) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodSelectorLabel.
func (in *PodSelectorLabel) DeepCopy() *PodSelectorLabel {
	if in == nil {
		return nil
	}
	out := new(PodSelectorLabel)
	in.DeepCopyInto(out)
	return out
}
